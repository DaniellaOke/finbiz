...
<!-- Mirrored from finbiz.pixcelsthemes.com/finbiz-html/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 12 Nov 2024 14:28:23 GMT -->
...
<body>
                        ...
                        <div class="main-header">
                            ...
                            <div class="button-area">
                                ...
                                <button id="menu-btn" class="menu rts-btn btn-primary-alta ml--20 ml_sm--5">
                                    <img class="menu-dark" src="{{ asset('asset/images/icon/menu.png')}}" alt="Menu-icon">
                                    <img class="menu-light" src="{{asset('asset/images/icon/menu-light.png')}}" alt="Menu-icon">
                                </button>
                            </div>
                        </div>
                    </div>
    ...
    <div id="side-bar" class="side-bar">
        ...
        <div class="rts-sidebar-menu-desktop">
            <a class="logo-1" href="index-2.html"><img class="logo" src="{{asset('assets/images/logo/logo-1.svg')}}" alt="finbiz_logo"></a>
            <a class="logo-2" href="index-2.html"><img class="logo" src="{{asset('assets/images/logo/logo-4.svg')}}" alt="finbiz_logo"></a>
            <a class="logo-3" href="index-2.html"><img class="logo" src="{{asset('assets/images/logo/logo-3.svg')}}" alt="finbiz_logo"></a>
            <a class="logo-4" href="index-2.html"><img class="logo" src="{{asset('assets/images/logo/logo-5.svg')}}" alt="finbiz_logo"></a>
            ...
            <div class="row g-5 align-items-center">
                        ...
                        <div class="row about-founder-wrapper align-items-center mt--40">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="author-inner">
                                    <a class="thumbnail" href="#"><img src="{{asset('assets/images/about/sm-01.png')}}" alt="finbiz_founder"></a>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12 mt_sm--20">
                                <div class="author-call-option">
                                    <img class="authore-call" src="{{asset('assets/images/about/call.svg')}}" alt="call_founder">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-12 order-lg-2 order-md-1 order-sm-1 order-1">
                    <div class="about-one-thumbnail">
                        ...
                        <img class="small-img" src="{{asset('assets/images/about/main/about-02.png')}}" alt="finbiz-small">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="business-goal-one">
                        ...
                        <img class="small" src="a{{asset('assets/images/business-goal/sm-01.jpg')}}" alt="Business_Goal">
                    </div>
                </div>
                <!-- business goal right -->
            ...
            <div class="row align-items-center g-0">
                ...
                <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="contact-form-area-one">
                        ...
                        <form id="contact-form" action="https://finbiz.pixcelsthemes.com/finbiz-html/mailer.php" method="post">
...
<!-- Mirrored from finbiz.pixcelsthemes.com/finbiz-html/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 12 Nov 2024 14:30:05 GMT -->
</html>